...
Area::Area() {
    ...
    while (getline(arch, line)) {
        ...
        for (i = 0; i < 200; i++) {
            if (line[i] == '1') {
                waterVertices.push_back(glm::vec4(x - 0.2f, -1.95f, z - 0.2f, 1.0f));
                waterVertices.push_back(glm::vec4(x + 1.2f, -1.95f, z - 0.2f, 1.0f));
                waterVertices.push_back(glm::vec4(x + 1.2f, -1.95f, z + 1.2f, 1.0f));

                waterVertices.push_back(glm::vec4(x - 0.2f, -1.95f, z - 0.2f, 1.0f));
                waterVertices.push_back(glm::vec4(x + 1.2f, -1.95f, z + 1.2f, 1.0f));
                waterVertices.push_back(glm::vec4(x - 0.2f, -1.95f, z + 1.2f, 1.0f));
                ...
                parksVertices.push_back(glm::vec4(x - 0.2f, -1.95f, z - 0.2f, 1.0f));
                parksVertices.push_back(glm::vec4(x + 1.2f, -1.95f, z - 0.2f, 1.0f));
                parksVertices.push_back(glm::vec4(x + 1.2f, -1.95f, z + 1.2f, 1.0f));

                parksVertices.push_back(glm::vec4(x - 0.2f, -1.95f, z - 0.2f, 1.0f));
                parksVertices.push_back(glm::vec4(x + 1.2f, -1.95f, z + 1.2f, 1.0f));
                parksVertices.push_back(glm::vec4(x - 0.2f, -1.95f, z + 1.2f, 1.0f));
