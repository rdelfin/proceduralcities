...
TriangleMesh::TriangleMesh(std::vector<glm::vec4> vertices, std::vector<glm::uvec3> faces,
                           const Shader& vertexShader, const Shader& geometryShader, const Shader& fragmentShader,
                           std::vector<ShaderUniform> uniforms)
    : vertices(vertices), faces(faces), program(uniforms, vertexShader, geometryShader, fragmentShader) {
